...
def generate_pdf_report(fig_scatter,
    ...
    methods_text = (
        "The methods section describes the approach taken in this research, including data "
        "collection and processing. We used NiBabel for reading and writing neuroimaging files, "
